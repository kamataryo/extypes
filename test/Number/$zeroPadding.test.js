...
test('zero padding 3.5)', t => t.deepEqual(
  123.4[$zeroPadding](4, false),
  '0123.4'
))

test('zero padding 4.5)', t => t.deepEqual(
  123.4[$zeroPadding](2, false),
  '23.4'
))
...
test('zero padding 8)', t => t.deepEqual(
  1.23[$zeroPadding](false, false),
  '1.23'
))
